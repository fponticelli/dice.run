...
doom_html_Render.prototype = {
	...
	,applyElementAttributes: function(srcDom,dstDom) {
		...
		var item1 = $iterator(thx__$Set_Set_$Impl_$)(srcAttrs);
		while(item1.hasNext()) {
			var item11 = item1.next();
			result.remove(item11);
		}
		var removed = result;
	...
	,applyNodeAttributes: function(attributes,dom) {
		...
		var item1 = $iterator(thx__$Set_Set_$Impl_$)(vdomAttrs);
		while(item1.hasNext()) {
			var item11 = item1.next();
			result.remove(item11);
		}
...
var Main = function(props,children) {
...
Main.sampleProbabilities = function(n,e) {
	var data = new view_DiceWorkerData(n,e);
	var _g = 0;
	while(_g < 100) {
		var i = _g++;
...
Main.prototype = $extend(doom_html_Component.prototype,{
	render: function() {
		...
		var value3 = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromString(Loc.msg.jumpersideasLink);
		...
		var value4 = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromString("prefix");
		if(__map_reserved["class"] != null) {
			_g4.setReserved("class",value4);
		} else {
			_g4.h["class"] = value4;
		}
		var children = doom_core__$VNode_VNode_$Impl_$.el("span",_g4,doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text(Loc.msg.asConfabulatedOn,null,null)]));
		var children1 = doom_core__$VNode_VNode_$Impl_$.el("br",null,null);
		var _g5 = new haxe_ds_StringMap();
		var value5 = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromString("domain");
		if(__map_reserved["class"] != null) {
...
var Expression = { __ename__ : ["Expression"], __constructs__ : ["Unparsed","Parsed","ParsedInvalid","Error"] };
...
Expression.ParsedInvalid = function(source,errors,expr) { var $x = ["ParsedInvalid",2,source,errors,expr]; $x.__enum__ = Expression; return $x; };
Expression.Error = function(source,err) { var $x = ["Error",3,source,err]; $x.__enum__ = Expression; return $x; };
var Std = function() { };
Std.__name__ = ["Std"];
		...
		case 0:
			...
			if(ord(f(a1),f(t._0)) == thx_OrderingImpl.LT) {
				...
				if(ord(f(a1),f(t1._1)) == thx_OrderingImpl.GT) {
					var this11 = { _0 : t1._0, _1 : a1};
					found = haxe_ds_Option.Some(this11);
				} else {
					found = found;
				}
			}
			break;
		case 1:
			var this12 = { _0 : a1, _1 : a1};
			found = haxe_ds_Option.Some(this12);
			break;
		default:
			found = found;
		}
...
thx__$Nel_Nel_$Impl_$.pop = function(this1) {
	var this11 = { _0 : thx__$Nel_Nel_$Impl_$.last(this1), _1 : thx__$Nel_Nel_$Impl_$.init(this1)};
	return this11;
};
...
thx__$Nel_Nel_$Impl_$.shift = function(this1) {
	var this11 = { _0 : thx__$Nel_Nel_$Impl_$.head(this1), _1 : thx__$Nel_Nel_$Impl_$.tail(this1)};
	return this11;
};
...
thx__$ReadonlyArray_ReadonlyArray_$Impl_$.shift = function(this1) {
	if(this1.length == 0) {
		var this11 = { _0 : null, _1 : this1};
		return this11;
	}
	var value = this1[0];
	var array = this1.slice(0,0).concat(this1.slice(1));
	var this12 = { _0 : value, _1 : array};
	return this12;
};
...
thx_promise_PromiseTuple5.join = function(p1,p2) {
	return thx_promise_Promises.par(function(f,g) {
		var this2 = { _0 : f._0, _1 : f._1, _2 : f._2, _3 : f._3, _4 : f._4, _5 : g};
		return this2;
	},p1,p2);
};
...
thx_promise_PromiseTuple4.join = function(p1,p2) {
	return thx_promise_Promises.par(function(f,g) {
		var this2 = { _0 : f._0, _1 : f._1, _2 : f._2, _3 : f._3, _4 : g};
		return this2;
	},p1,p2);
};
...
thx_promise_PromiseTuple3.join = function(p1,p2) {
	return thx_promise_Promises.par(function(f,g) {
		var this2 = { _0 : f._0, _1 : f._1, _2 : f._2, _3 : g};
		return this2;
	},p1,p2);
};
...
thx_promise_PromiseTuple2.join = function(p1,p2) {
	return thx_promise_Promises.par(function(f,g) {
		var this2 = { _0 : f._0, _1 : f._1, _2 : g};
		return this2;
	},p1,p2);
};
			...
			other.message(function(msg1) {
				...
				case 0:
					if(left[1] == 0) {
						...
						var this11 = { _0 : a2, _1 : b1};
						o.message(thx_stream_Message.Next(this11));
					} else {
						var b2 = msg1[2];
...
view_ExpressionInput.renderValidationsErrors = function(err) {
	var _g2 = new haxe_ds_StringMap();
	var value = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromString("validation-prefix");
	if(__map_reserved["class"] != null) {
		_g2.setReserved("class",value);
	} else {
		_g2.h["class"] = value;
	}
	var array = Loc.msg.validationPrefix;
	var children = doom_core__$VNode_VNode_$Impl_$.el("div",_g2,doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text(array[Std.random(array.length)],null,null)]));
	var _g3 = new haxe_ds_StringMap();
	var value1 = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromString("validation-messages");
	if(__map_reserved["class"] != null) {
		_g3.setReserved("class",value1);
	} else {
		_g3.h["class"] = value1;
	}
	return doom_core__$VNode_VNode_$Impl_$.el("div",null,doom_core__$VNodes_VNodes_$Impl_$.children([children,doom_core__$VNode_VNode_$Impl_$.el("div",_g3,doom_core__$VNodes_VNodes_$Impl_$.children(thx__$Nel_Nel_$Impl_$.toArray(err).map(function(e) {
		var _g4 = new haxe_ds_StringMap();
		var value2 = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromString("validation-message");
		if(__map_reserved["class"] != null) {
...
view_ExpressionInput.rangeToString = function(range) {
	...
	case 0:
		var value = range[2];
		return StringTools.replace(Loc.msg.exact,"$value","" + value);
	case 1:
		var maxInclusive = range[3];
		var minInclusive = range[2];
		return StringTools.replace(StringTools.replace(Loc.msg.between,"$minInclusive","" + minInclusive),"$maxInclusive","" + maxInclusive);
	case 2:
		var value1 = range[2];
		return StringTools.replace(Loc.msg.valueOrMore,"$value","" + value1);
	case 3:
		var value2 = range[2];
		return StringTools.replace(Loc.msg.valueOrLess,"$value","" + value2);
	case 4:
		var arr = range[2];
		return arr.map(view_ExpressionInput.rangeToString).join(" " + Loc.msg.or + " ");
	}
};
view_ExpressionInput.validationMessage = function(m) {
	switch(m[1]) {
	case 0:
		var sides = m[2];
		return StringTools.replace(Loc.msg.insufficientSides,"$sides","" + sides);
	case 1:
		return Loc.msg.emptySet;
	case 2:
		var range = m[3];
		var sides1 = m[2];
		return StringTools.replace(StringTools.replace(Loc.msg.infiniteReroll,"$sides","" + sides1),"$range",view_ExpressionInput.rangeToString(range));
	case 3:
		var toDrop = m[3];
		var available = m[2];
		return StringTools.replace(StringTools.replace(Loc.msg.tooManyDrops,"$available","" + available),"$toDrop","" + toDrop);
	case 4:
		var toKeep = m[3];
		var available1 = m[2];
		return StringTools.replace(StringTools.replace(Loc.msg.tooManyKeeps,"$available","" + available1),"$toKeep","" + toKeep);
	case 5:
		return Loc.msg.dropOrKeepShouldBePositive;
	}
};
view_ExpressionInput.renderParseError = function(err) {
	var _g = new haxe_ds_StringMap();
	var value = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromString("label");
	if(__map_reserved["class"] != null) {
		_g.setReserved("class",value);
	} else {
		_g.h["class"] = value;
	}
	var tmp = [doom_core__$VNode_VNode_$Impl_$.el("span",_g,doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text(Loc.msg.expectedOneOf,null,null)])),doom_core__$VNode_VNode_$Impl_$.el("br",null,null)].concat(thx_Arrays.interspersef(err.expected.map(function(_) {
		var _g1 = new haxe_ds_StringMap();
		var value1 = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromString("expected");
		if(__map_reserved["class"] != null) {
			_g1.setReserved("class",value1);
		} else {
			_g1.h["class"] = value1;
		}
		return doom_core__$VNode_VNode_$Impl_$.el("span",_g1,doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text(_,null,null)]));
	}),function() {
		return doom_core__$VNode_VNode_$Impl_$.el("span",null,doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text(", ",null,null)]));
	}));
	var tmp1 = doom_core__$VNode_VNode_$Impl_$.el("br",null,null);
	...
	var tmp2 = tmp.concat([tmp1,doom_core__$VNode_VNode_$Impl_$.el("span",_g11,doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text(Loc.msg.found,null,null)]))]);
	var _g2 = err.positionToString();
	var tmp3;
	switch(_g2[1]) {
	case 0:
		var content = _g2[2];
		var tmp4 = doom_core__$VNode_VNode_$Impl_$.el("br",null,null);
		var _g21 = new haxe_ds_StringMap();
		var value3 = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromString("got");
		if(__map_reserved["class"] != null) {
			_g21.setReserved("class",value3);
		} else {
			_g21.h["class"] = value3;
		}
		tmp3 = [tmp4,doom_core__$VNode_VNode_$Impl_$.el("span",_g21,doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text(content,null,null)]))];
		break;
	case 1:
		var _g22 = new haxe_ds_StringMap();
		var value4 = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromString("eof");
		if(__map_reserved["class"] != null) {
			_g22.setReserved("class",value4);
		} else {
			_g22.h["class"] = value4;
		}
		tmp3 = [doom_core__$VNode_VNode_$Impl_$.el("span",_g22,doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text(" " + Loc.msg.endOfFile,null,null)]))];
		break;
	}
	return tmp2.concat(tmp3);
};
...
var view_ProbabilitiesView = function(props) {
	doom_html_Component.call(this,props,doom_core__$VNodes_VNodes_$Impl_$.children([]));
	view_ProbabilitiesView.view = this;
	view_ProbabilitiesView.post(props.expression);
};
view_ProbabilitiesView.__name__ = ["view","ProbabilitiesView"];
view_ProbabilitiesView.post = function(expr) {
	view_ProbabilitiesView.worker.postMessage({ expression : expr});
};
view_ProbabilitiesView.percent = function(v) {
	var f = thx_format_NumberFormat.fixed(v * 100,view_ProbabilitiesView.ROUND).split(".");
	f[1] = thx_Strings.trimCharsRight(f[1],"0");
	f = f.filter(thx_Strings.hasContent);
	return f.join(".") + "%";
};
view_ProbabilitiesView.__super__ = doom_html_Component;
view_ProbabilitiesView.prototype = $extend(doom_html_Component.prototype,{
	migrationFields: function() {
		return doom_html_Component.prototype.migrationFields.call(this).concat(["worker"]);
	}
	,render: function() {
		...
		var range = max - min;
		var bucketSize = this.findBucketSize(range);
		var ps = Loc.msg.probabilitiesStats;
		if(bucketSize > 1) {
			stats = this.props.probabilities.bucket(bucketSize).stats();
			ps = Loc.msg.probabilitiesStatsWithBucket;
		}
		var f = function(f1) {
		...
		var children = doom_core__$VNode_VNode_$Impl_$.el("div",_g1,doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text(StringTools.replace(StringTools.replace(StringTools.replace(StringTools.replace(ps,"$minValue",f(min)),"$maxValue",f(max)),"$count",f(stats.count)),"$bucketSize",f(bucketSize)),null,null)]));
		var _g2 = new haxe_ds_StringMap();
		var value2 = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromString("probabilities-container");
		if(__map_reserved["class"] != null) {
			_g2.setReserved("class",value2);
		} else {
			_g2.h["class"] = value2;
		...
		var _g3 = new haxe_ds_StringMap();
		var value3 = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromString("probabilities");
		if(__map_reserved["class"] != null) {
		...
		var f2 = $bind(this,this.renderAtLeast);
		var a1 = bucketSize;
		var children1 = doom_core__$VNode_VNode_$Impl_$.el("div",_g4,doom_core__$VNodes_VNodes_$Impl_$.children(stats.map(function(a2) {
			return f2(a1,a2);
		})));
		var _g5 = new haxe_ds_StringMap();
		...
		var f3 = $bind(this,this.renderProb);
		var a11 = bucketSize;
		var children2 = doom_core__$VNode_VNode_$Impl_$.el("div",_g5,doom_core__$VNodes_VNodes_$Impl_$.children(stats.map(function(a21) {
			return f3(a11,a21);
		})));
		var _g6 = new haxe_ds_StringMap();
		var value6 = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromString("barchart");
		if(__map_reserved["class"] != null) {
			_g6.setReserved("class",value6);
		} else {
			_g6.h["class"] = value6;
		}
		var f4 = $bind(this,this.renderAtMost);
		var a12 = bucketSize;
		var children3 = doom_core__$VNode_VNode_$Impl_$.el("div",_g3,doom_core__$VNodes_VNodes_$Impl_$.children([children1,children2,doom_core__$VNode_VNode_$Impl_$.el("div",_g6,doom_core__$VNodes_VNodes_$Impl_$.children(stats.map(function(a22) {
			return f4(a12,a22);
		})))]));
		var _g7 = new haxe_ds_StringMap();
		var value7 = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromString("probabilities-labels");
		if(__map_reserved["class"] != null) {
			_g7.setReserved("class",value7);
		} else {
			_g7.h["class"] = value7;
		...
		var children4 = doom_core__$VNode_VNode_$Impl_$.el("div",_g8,doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text(Loc.msg.atLeast,null,null)]));
		var _g9 = new haxe_ds_StringMap();
		...
		var children5 = doom_core__$VNode_VNode_$Impl_$.el("div",_g9,doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text(Loc.msg.probabilities,null,null)]));
		var _g10 = new haxe_ds_StringMap();
		var value10 = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromString("label");
		if(__map_reserved["class"] != null) {
			_g10.setReserved("class",value10);
		} else {
			_g10.h["class"] = value10;
		}
		return doom_core__$VNode_VNode_$Impl_$.el("div",_g,doom_core__$VNodes_VNodes_$Impl_$.children([children,doom_core__$VNode_VNode_$Impl_$.el("div",_g2,doom_core__$VNodes_VNodes_$Impl_$.children([children3,doom_core__$VNode_VNode_$Impl_$.el("div",_g7,doom_core__$VNodes_VNodes_$Impl_$.children([children4,children5,doom_core__$VNode_VNode_$Impl_$.el("div",_g10,doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text(Loc.msg.atMost,null,null)]))]))]))]));
	}
	,findBucketSize: function(range) {
		var threshold = 100;
		if(range <= threshold) {
			return 1;
		}
	...
	,willUnmount: function() {
		view_ProbabilitiesView.view = null;
	}
	,mouseEnter: function(value) {
		var _gthis = this;
		return function() {
			_gthis.update({ expression : _gthis.props.expression, parsed : _gthis.props.parsed, probabilities : _gthis.props.probabilities, selected : haxe_ds_Option.Some(value)},{ fileName : "ProbabilitiesView.hx", lineNumber : 121, className : "view.ProbabilitiesView", methodName : "mouseEnter"});
		};
	}
	,renderProb: function(bucketSize,sample) {
		var _g1 = new haxe_ds_StringMap();
		var _g = new haxe_ds_StringMap();
		...
		var children = doom_core__$VNode_VNode_$Impl_$.el("div",_g2,doom_core__$VNodes_VNodes_$Impl_$.children([doom_core__$VNode_VNode_$Impl_$.el("div",_g3,doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text(this.formatValue(bucketSize,sample.value),null,null)]))]));
		var _g4 = new haxe_ds_StringMap();
		...
		var value7 = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromString("height: " + this.height(sample.get_maxPercent() * view_ProbabilitiesView.barHeight));
		if(__map_reserved["style"] != null) {
	...
	,renderAtMost: function(bucketSize,sample) {
		var _g1 = new haxe_ds_StringMap();
		var _g = new haxe_ds_StringMap();
		if(__map_reserved["bar-container"] != null) {
			_g.setReserved("bar-container",true);
		...
		var value7 = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromString("height: " + this.height(sample.get_accPercent() * view_ProbabilitiesView.barHeight));
		if(__map_reserved["style"] != null) {
			_g4.setReserved("style",value7);
		} else {
			_g4.h["style"] = value7;
		...
		return doom_core__$VNode_VNode_$Impl_$.el("div",_g1,doom_core__$VNodes_VNodes_$Impl_$.children([children,children1,doom_core__$VNode_VNode_$Impl_$.el("div",_g5,doom_core__$VNodes_VNodes_$Impl_$.children([doom_core__$VNode_VNode_$Impl_$.el("div",_g6,doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text(view_ProbabilitiesView.percent(sample.get_accPercent()),null,null)]))]))]));
	}
	,renderAtLeast: function(bucketSize,sample) {
		...
		var value7 = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromString("height: " + this.height(v * view_ProbabilitiesView.barHeight));
		if(__map_reserved["style"] != null) {
			_g4.setReserved("style",value7);
		} else {
			_g4.h["style"] = value7;
		...
		return doom_core__$VNode_VNode_$Impl_$.el("div",_g1,doom_core__$VNodes_VNodes_$Impl_$.children([children,children1,doom_core__$VNode_VNode_$Impl_$.el("div",_g5,doom_core__$VNodes_VNodes_$Impl_$.children([doom_core__$VNode_VNode_$Impl_$.el("div",_g6,doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text(view_ProbabilitiesView.percent(v),null,null)]))]))]));
	}
	,formatValue: function(bucketSize,value) {
		if(bucketSize == 1) {
			return "" + value;
		} else {
	...
	,classes: function() {
		return "view_probabilities-view";
	}
	,__class__: view_ProbabilitiesView
});
...
view_RollDetailsView.prototype = $extend(doom_html_Component.prototype,{
	...
	,renderRolls: function(rolls,result,reducer) {
		...
		if(rolls.length == 1) {
			var _g = new haxe_ds_StringMap();
			var value = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromString("reduce");
			if(__map_reserved["class"] != null) {
				_g.setReserved("class",value);
			} else {
				_g.h["class"] = value;
			}
			var children = doom_core__$VNodes_VNodes_$Impl_$.children([this.displayReducer(reducer)]);
			return doom_core__$VNode_VNode_$Impl_$.el("div",_g,doom_core__$VNodes_VNodes_$Impl_$.children(rolls.concat(children)));
		} else {
			return this.details(result,function() {
				var _g1 = new haxe_ds_StringMap();
				var value1 = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromString("dice-set");
				if(__map_reserved["class"] != null) {
					_g1.setReserved("class",value1);
				} else {
					_g1.h["class"] = value1;
				}
				var content = [doom_core__$VNode_VNode_$Impl_$.el("div",_g1,doom_core__$VNodes_VNodes_$Impl_$.children(rolls))];
				var _g11 = new haxe_ds_StringMap();
				var value2 = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromString("reduce");
				if(__map_reserved["class"] != null) {
					_g11.setReserved("class",value2);
				} else {
					_g11.h["class"] = value2;
				}
				return doom_core__$VNode_VNode_$Impl_$.el("div",_g11,doom_core__$VNodes_VNodes_$Impl_$.children(content.concat(doom_core__$VNodes_VNodes_$Impl_$.children([_gthis.displayReducer(reducer)]))));
			});
		}
	}
	,displayReducer: function(reducer) {
		...
		case 4:
			return doom_core__$VNode_VNode_$Impl_$.el("div",null,doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text("median",null,null)]));
		}
	}
...
view_RollView.__name__ = ["view","RollView"];
...
view_RollView.prototype = $extend(doom_html_Component.prototype,{
	...
	,rollEffect: function() {
		var x;
		var list = dots_Query.selectNodes(".roll",null);
		thx_Arrays.each(Array.prototype.slice.call(list,0),function(el) {
			var _g = 1;
			while(_g < 6) {
				var i = _g++;
				el.classList.remove("roll" + i);
			}
			x = el.offsetWidth;
			var r = Math.ceil(Math.random() * 5);
			el.classList.add("roll" + r);
		});
		return x;
	}
	,classes: function() {
		return "view_roll-view";
	}
...
view_ProbabilitiesView.worker = (function($this) {
	var $r;
	...
	worker.onmessage = function(e) {
		...
		var tmp = "" + view_ProbabilitiesView.STORAGE_PREFIX + expr;
		var tmp1 = JSON.stringify(e.data.results);
		storage.setItem(tmp,tmp1);
		if(null != view_ProbabilitiesView.view && expr == view_ProbabilitiesView.view.props.expression) {
			view_ProbabilitiesView.view.update({ expression : view_ProbabilitiesView.view.props.expression, parsed : view_ProbabilitiesView.view.props.parsed, probabilities : p, selected : view_ProbabilitiesView.view.props.selected},{ fileName : "ProbabilitiesView.hx", lineNumber : 24, className : "view.ProbabilitiesView", methodName : "worker"});
		}
	};
	var collect = { };
	{
		...
		while(_g1 < _g) {
			...
			if(!StringTools.startsWith(key,view_ProbabilitiesView.STORAGE_PREFIX)) {
				continue;
			}
			var ob = JSON.parse(storage.getItem(key));
			var k = key.substring(view_ProbabilitiesView.STORAGE_PREFIX.length);
			collect[k] = ob;
		}
	}
